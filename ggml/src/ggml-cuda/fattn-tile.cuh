...
static constexpr __host__ __device__ uint32_t ggml_cuda_fattn_tile_get_config_nvidia_fp32(const int DKQ, const int DV, const int ncols) {
    ...
    GGML_CUDA_FATTN_TILE_CONFIG_CASE( 40,  40,  8, 128, 2,  32,  40)
    GGML_CUDA_FATTN_TILE_CONFIG_CASE( 40,  40, 16, 128, 3,  32,  40)
    GGML_CUDA_FATTN_TILE_CONFIG_CASE( 40,  40, 32, 256, 3,  64,  40)
    ...
    GGML_CUDA_FATTN_TILE_CONFIG_CASE( 72,  72,  4, 256, 2, 128,  72)
    GGML_CUDA_FATTN_TILE_CONFIG_CASE( 72,  72,  8, 128, 2,  64,  72)
    GGML_CUDA_FATTN_TILE_CONFIG_CASE( 72,  72, 16, 256, 3,  64,  72)
    GGML_CUDA_FATTN_TILE_CONFIG_CASE( 72,  72, 32, 256, 2,  64,  72)

    GGML_CUDA_FATTN_TILE_CONFIG_CASE( 80,  80,  2,  64, 2,  32,  40)
    GGML_CUDA_FATTN_TILE_CONFIG_CASE( 80,  80,  4, 256, 3,  64,  80)
    GGML_CUDA_FATTN_TILE_CONFIG_CASE( 80,  80,  8, 128, 2,  64,  80)
    GGML_CUDA_FATTN_TILE_CONFIG_CASE( 80,  80, 16, 256, 3,  64,  80)
    GGML_CUDA_FATTN_TILE_CONFIG_CASE( 80,  80, 32, 256, 3,  64,  40)

    GGML_CUDA_FATTN_TILE_CONFIG_CASE( 96,  96,  2,  64, 2,  32,  48)
    GGML_CUDA_FATTN_TILE_CONFIG_CASE( 96,  96,  4, 256, 3,  64,  96)
    GGML_CUDA_FATTN_TILE_CONFIG_CASE( 96,  96,  8, 128, 2,  64,  96)
    GGML_CUDA_FATTN_TILE_CONFIG_CASE( 96,  96, 16, 256, 3,  64,  48)
    GGML_CUDA_FATTN_TILE_CONFIG_CASE( 96,  96, 32, 256, 2,  64,  96)

    GGML_CUDA_FATTN_TILE_CONFIG_CASE(112, 112,  2, 128, 2,  64, 112)
    GGML_CUDA_FATTN_TILE_CONFIG_CASE(112, 112,  4, 256, 3,  64, 112)
    GGML_CUDA_FATTN_TILE_CONFIG_CASE(112, 112,  8, 128, 2,  32, 112)
    GGML_CUDA_FATTN_TILE_CONFIG_CASE(112, 112, 16, 256, 3,  64, 112)
    GGML_CUDA_FATTN_TILE_CONFIG_CASE(112, 112, 32, 256, 2,  64,  56)
